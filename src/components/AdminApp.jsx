...
const AdminApp = () => {
    ...
    const hola=(menu,accion)=>{        
        ...
        accion==='actualizar'? setHabmodal(!habmodal): setModaldelete(!modaldelete)
  ...
  return (
                ...
                (
                    ...
                    <tbody id="table_body">                                            
                      {menus.map((menu, index) => (
                        ...
                        <td>{menu.precio}</td>
                        <td><button className="btn btn-warning" onClick={()=>hola(menu,'actualizar')}>Editar</button></td>                        
                        <td><button className="btn btn-danger" onClick={()=>hola(menu,'eliminar')}>Eliminar</button></td>
                        </tr>                                              
                      ))
                     }
                    </tbody>
    ...
    <Modal  isOpen={habmodal}>
            ...
            <ModalBody>
                ...
                <input className="form-control" type="text" name="nombre" id="nombre" value={menuselecc.nombre} onChange={handleChangeact} readOnly/>
                <br />
                <label htmlFor="nombre">Categoria</label>
                <input className="form-control" type="text" name="nombcateg" id="nombcateg" value={menuselecc.nombcateg} onChange={handleChangeact}/>
                <br />
                <label htmlFor="nombre">Precio</label>
                <input className="form-control" type="text" name="precio" id="precio" value={menuselecc.precio} onChange={handleChangeact}/>
                <br />
                <label htmlFor="capital_bursatil">Imagen</label>
                <input className="form-control" type="text" name="img" id="img" value={menuselecc.img} onChange={handleChangeact}/>
                <br></br>
                <label>Activar</label>    
                <select 
                name="activo"
            ...
            <ModalFooter>
                <button  className='btn btn-success' onClick={()=>guardaract(menuselecc,menuselecc._id)}>Guardar</button>
                <button className='btn btn-danger' onClick={()=>setHabmodal(!habmodal)}>Cancelar</button>
            </ModalFooter>
     </Modal>
     ...
     <ModalFooter>
         <button  className='btn btn-success' onClick={()=>eliminar(menuselecc._id)}>Guardar</button>
